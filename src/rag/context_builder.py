...
(Exact/Relaxed/Fallback) and every relaxation step actually tried are
included explicitly, since the generation prompt must never claim a
relaxed/fallback result satisfies a constraint that was never verified.
"""
